<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderInner.ascx.cs" Inherits="AGH_Site.Controls.EN.HeaderInner" %>
<!-- preloader -->
...
<header class="main-header header-style-11">
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo">
                <a href="../../Default.aspx" title="Buildnox">
                    <img src="Assest/Images/uploads/2023/03/logo.png?v=1.1.0" alt="AGH" style="" /></a>
            </div>
