<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="AGH_Site.Controls.EN.Footer" %>
    ...
    <div class="auto-container">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 footer-column">
                <div class="footer-widget1 about-widget col-lg-10 col-md-10 col-sm-12">
                    <h3>AGH</h3>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="single-item">
                            <p>Send a message</p>
                            <h4><a href="mailto:info@aghinvest.com">info@aghinvest.com</a></h4>
                        </div>
                        <div class="single-item">
                            <p>Location</p>
                            <h4>United States & Morocco</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 footer-column">
                <div class="footer-widget">
                    <div class="row clearfix">
                        <div class="col-lg-8 col-md-8 col-sm-12 links-column">
                        ...
                        <%--<div class="col-lg-6 col-md-6 col-sm-12 links-column">
                            <div class="links-widget">
                                ...
                                <ul class="links-list clearfix style-two">
                    ...
                    <div class="copyright">
                        ...
                        <p>&copy; Copyright  <a href="#">AGH </a> <%= DateTime.Now.Year %> . Atlas Global Holdings, Inc. All rights reserved.</p>
                        <p>This website is for informational purposes only and does not constitute an offer to sell or a solicitation to buy any securities.</p>
                    </div>
